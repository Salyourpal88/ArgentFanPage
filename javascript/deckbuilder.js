...
function getDataButtons(data) {
  ...
  enterListener(".name-filter", filteredList);
  enterListener(".element-filter", filteredList);
  enterListener(".cost-filter", filteredList);
  enterListener(".power-filter", filteredList);
  enterListener(".type-filter", filteredList);
  enterListener(".subtype-filter", filteredList);
  enterListener(".effect-filter", filteredList);
...
function enterListener(input, filteredList) {
