...
convertImage("../Promos/hokken-archaeologist.webp")
convertImage("../Promos/hadir-boy-of-the-sacred-forest.webp")
convertImage("../Promos/fragment-of-the-forgotten-one.webp")
convertImage("../Promos/hokken-warding-amulet.webp")
convertImage("../Promos/neferia-the-queens-assassin.webp")
convertImage("../Promos/pengardian-legend-hanzo.webp")
convertImage("../Promos/renna-feral-warrior.webp")
convertImage("../Promos/shardwork-arbiter.webp")
convertImage("../Promos/tux-the-emperor-spirit-1.webp")
convertImage("../Promos/hokken-archaeologist.webp")
convertImage("../Promos/zane-hero-of-hyldia.webp")
